...
enddo
!-----------------------------------------------------------------------
open (unit=10,file="../output/fluc_prime.dat")

write(10,'(A,F20.10,I9,A)')'TITLE ="',time,nstep,'"'
write(10,'(A)')"Variables =x,y,z,rho',u',v',w',e',t',p' "
!write(10,'(A)')'Variables ="x","y","z","rho","u","V_prime","W_prime","E_prime","T_prime","P_prime"' 
